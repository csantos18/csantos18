...
| [Sistema de Controle de Entregas e Tarefas Operacionais](https://github.com/csantos18/sistema-controle-entregas-tarefas-operacionais) | Projeto autoral | Pronto para deploy | Sistema operacional para controle de entregas e tarefas, com painel administrativo, dashboard, SLA por categoria, status de rota, anexos, comprovante de conclusão, relatórios, auditoria, usuários, tema por cliente e base para PostgreSQL. | JavaScript, Node.js, Express, PostgreSQL |
| [Saúde em Dia](https://github.com/csantos18/saude-em-dia) | Projeto autoral | Pronto para deploy | Plataforma de saúde preventiva para acompanhamento orientativo de riscos, exames, vacinas, hábitos e planos de cuidado, com regras auditáveis, alertas, documentação técnica e preparação para Vercel com Supabase/Postgres. | Python, Django, PostgreSQL, Supabase, Vercel |
